	...
	ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnStartNewGame) {
				String firstDim = JOptionPane.showInputDialog(frame, "Please Enter The" + "First Dimension :");
				String secondDim = JOptionPane.showInputDialog(frame, "Please Enter The" + "Second Dimension :");
				// send the dimensions
			...
			if (e.getSource() == btnInstructions) {
				JOptionPane.showMessageDialog(null, "Welcome to our Programme PHPMYADMIN ÈÇáÚÑÈí\n"
						+ "---------------------------------------------------------------- \n"
						...
						+ "---------------------------------------------------------------- \n"
						+ "Feel free to use the programme ^_^", "Instructions", JOptionPane.INFORMATION_MESSAGE);
			}
		};
	};
